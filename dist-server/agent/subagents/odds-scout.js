...
\`\`\``;
export async function runOddsScout(fixture, sport, sessionId, onStep, taskOverride) {
 ...
 */
export async function runOddsScoutMulti(fixtures, sport, matchDate, sessionId, onStep) {
    const season = getCurrentSeason();
...
//# sourceMappingURL=odds-scout.js.map