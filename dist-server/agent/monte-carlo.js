...
function dixonColesTau(homeGoals, awayGoals, lambdaH, lambdaA, rho = 0.1) {
...
export function runMonteCarlo(input) {
    ...
    for (const [k, v] of Object.entries(scoreMap)) {
        ...
        if (prob > 0.005)
            correctScoreDistribution[k] = Math.round(prob * 1000) / 1000;
    }
...
export function getMCProbForMarket(mc, market) {
