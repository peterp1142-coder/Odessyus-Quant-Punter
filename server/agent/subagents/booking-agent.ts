...
import type { BookingRequest, BookingResult, PlatformId } from '../../booking/types.js';
...
function parseBookingRequest(finalAnswer: string, override?: Partial<BookingRequest>): Partial<BookingRequest> {
...
export async function runBookingAgent(opts: {
  ...
  const platform = (overrides?.platform || process.env.BOOKING_PLATFORM || 'sportybet') as PlatformId;
